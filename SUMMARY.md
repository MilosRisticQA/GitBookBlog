...
* [Automation testing](topics/untitled/README.md)
  * [Selenium & C\#](topics/untitled/selenium-and-c/README.md)
    * [Test Framework](topics/untitled/selenium-and-c/test-framework/README.md)
      * [Visual Studio](topics/untitled/selenium-and-c/test-framework/visual-studio.md)
      * [VS Code](topics/untitled/selenium-and-c/test-framework/vs-code.md)
    * [SpecFlow](topics/untitled/selenium-and-c/specflow.md)
  * [WebdriverIo & JS](topics/untitled/webdriverio-and-js/README.md)
    * [Cucumber test framework](topics/untitled/webdriverio-and-js/cucumber-test-framework.md)
    * [Mocha test framework](topics/untitled/webdriverio-and-js/mocha-test-framework.md)
    * [Jasmin test framework](topics/untitled/webdriverio-and-js/jasmin-test-framework.md)
  * [Jmeter](topics/untitled/jmeter.md)
  * [Postman](topics/untitled/postman/README.md)
    * [Newman](topics/untitled/postman/newman.md)
  * [TDD and BDD](topics/untitled/tdd-and-bdd.md)
  * [Test Management Tools](topics/untitled/test-management-tools/README.md)
...
* [C\#](programming-languages/c/README.md)
  ...
  * [C\#: Basics](programming-languages/c/c-common-syntax/README.md)
    * [Variables and Conditionals](programming-languages/c/c-common-syntax/variables-and-conditionals/README.md)
      ...
      * [Type Conversion](programming-languages/c/c-common-syntax/variables-and-conditionals/type-conversion.md)
    * [Loops and Sets](programming-languages/c/c-common-syntax/loops-and-sets/README.md)
      * [Do / While loop](programming-languages/c/c-common-syntax/loops-and-sets/do-while-loop.md)
      * [Set: Arrays](programming-languages/c/c-common-syntax/loops-and-sets/set-arrays.md)
      * [Set: Lists](programming-languages/c/c-common-syntax/loops-and-sets/set-lists.md)
      * [Sets: Dictionary](programming-languages/c/c-common-syntax/loops-and-sets/sets-dictionary.md)
      * [For Loop](programming-languages/c/c-common-syntax/loops-and-sets/for-loop.md)
      * [Foreach Loop](programming-languages/c/c-common-syntax/loops-and-sets/foreach-loop.md)
    * [Methods](programming-languages/c/c-common-syntax/methods.md)
  * [C\# - Debugging](programming-languages/c/c-debugging.md)
  * [C\# - OOP](programming-languages/c/c-oop/README.md)
    * [Class types - Static Classes](programming-languages/c/c-oop/class-types-static-classes.md)
    * [Class Types - Instantiated Classes](programming-languages/c/c-oop/class-types-instantiated-classes.md)
    * [Class Options - Properties](programming-languages/c/c-oop/class-options-properties.md)
    * [Class Options - Namespaces](programming-languages/c/c-oop/class-options-namespaces.md)
    * [Class Libraries](programming-languages/c/c-oop/class-libraries.md)
...
* [SQL](databases/sql/README.md)
  * [SQL Server](databases/sql/sql-server/README.md)
    * [Connecting to Database Engine](databases/sql/sql-server/connecting-to-the-database-engine-locally.md)
...
* [Automation Servers](ci-cd/automation-servers/README.md)
  ...
  * [BitBucket](ci-cd/automation-servers/bitbucket.md)
  * [Azure DevOps](ci-cd/automation-servers/azure-devops.md)
